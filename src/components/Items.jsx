...
export default function Items() {
  ...
  const daftarBarang = [
    { id: 1, nama: "Parsnip", harga: 35, emoji: "🥕" },
    { id: 2, nama: "Batu", harga: 2, emoji: "🪨" },
    { id: 3, nama: "Kayu", harga: 2, emoji: "🪵" },
    { id: 4, nama: "Berlian", harga: 750, emoji: "💎" },
  ];

  return (
    <div className="bg-white p-6 rounded-2xl shadow-xl border-2 border-amber-200 w-full max-w-md">
        ...
        {daftarBarang.map((barang) => (
          ...
          >
            <div className="flex items-center gap-3">
              <span className="text-2xl">{barang.emoji}</span>
              <div>
            ...
            <button
              onClick={() => setIsiRansel(isiRansel + 1)}
